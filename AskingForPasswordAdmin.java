 ...
 * @author Elmasry
 */
public class AskingForPasswordAdmin extends javax.swing.JFrame {

    /**
     * Creates new form AskingForPasswordAdmin
     */
    public AskingForPasswordAdmin() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if (Admin.name.equals(nameText.getText()) && Admin.password.equals(passText.getText())) {
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskingForPasswordAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AskingForPasswordAdmin().setVisible(true);
            }
        });
    }
